                    ...
                    <ul class="navbar-nav ml-auto mr-3">
                        ...
                        @guest
                            <li class="nav-item pl-2">
                                <a class="nav-link" href="{{ route('login') }}" style="font-family:B Mehr;">{{ __('ورود') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item pl-3">
                                    <a class="nav-link" href="{{ route('register') }}" style="font-family:B Mehr;">{{ __('ثبت نام') }}</a>
                                </li>
                            @endif
                        @else
                                ...
                                <div class="dropdown-menu dropdown-menu-right text-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" style="font-family:B Mehr; font-weight:bold;">
                                        {{ __('خروج') }}
                                    </a>
